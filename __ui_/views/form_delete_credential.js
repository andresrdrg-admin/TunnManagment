let form_delete_credential = `<!-- Button trigger modal -->
    ...
    <div class="modal-dialog        ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="{id_modal}Label">Eliminar Credencial</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>¿Está seguro de eliminar la categoría nombrada a continuación?</p>
                <div class="mb-3">
